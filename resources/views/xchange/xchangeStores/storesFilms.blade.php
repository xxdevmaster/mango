...
<div class="title">
	<h1 class="h1">
		<a href="/CPTitles" class="text-primary" >Xchange </a> / <a href="/xchange/stores/" class="text-primary" >Store </a> / {{ isset($store->title) ? $store->title : ""}}
	</h1>
</div>
<hr class="hrLine">
...
<div id="storeFilms">
	@include('xchange.xchangeStores.filmList_partial')
</div>
@stop