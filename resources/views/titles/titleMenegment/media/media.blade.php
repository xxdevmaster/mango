		...
		<div class="col-lg-12">
			...
			<div class="tab-content">
				<div class="tab-pane fade in active" id="tab-streaming">
					@include('titles.titleMenegment.media.partials.streaming.streaming')
				</div>
				<div class="tab-pane fade" id="tab-storage">
					@include('titles.titleMenegment.media.partials.storage.storage')
				</div>
				<div class="tab-pane fade" id="tab-dubbedVersions">
					@include('titles.titleMenegment.media.partials.dubbedVersions.dubbedVersions')
				</div>
				<div class="tab-pane fade" id="tab-extras">
					@include('titles.titleMenegment.media.partials.extras.extras')
				</div>
				<div class="tab-pane fade" id="tab-vimeo">
					@include('titles.titleMenegment.media.partials.vimeo.vimeo')
				</div>
				<div class="tab-pane fade" id="tab-uploader">
					@include('titles.titleMenegment.media.partials.uploader.uploader')
				</div>
			</div>
		</div>
	</div>
