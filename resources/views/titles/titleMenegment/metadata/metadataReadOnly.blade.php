@extends('titles.titleMenegment.titleMenegmentReadOnly')
@section('titleMenegmentReadOnly')	
	<div class="m-h-50">
		<div class="col-lg-12"> 
			...
			<div class="tab-content">
				<div class="tab-pane fade in active" id="basic">
					@include('titles.titleMenegment.metadata.partials.basic.basicReadOnly')
				</div>
				<div class="tab-pane fade" id="advanced"> 
					@include('titles.titleMenegment.metadata.partials.advanced.advancedReadOnly')
				</div> 
				<div class="tab-pane fade" id="castAndCrew"> 
					@include('titles.titleMenegment.metadata.partials.castAndCrew.castAndCrewReadOnly')
				</div> 
				<div class="tab-pane fade" id="images"> 
					@include('titles.titleMenegment.metadata.partials.images.imagesReadOnly')
				</div> 								
				<div class="tab-pane fade" id="subtitles"> 
					@include('titles.titleMenegment.metadata.partials.subtitles.subtitlesReadOnly')
				</div> 
				<div class="tab-pane fade" id="ageRates"> 
					@include('titles.titleMenegment.metadata.partials.ageRates.ageRatesReadOnly')
				</div> 
				<div class="tab-pane fade" id="series"> 
					@include('titles.titleMenegment.metadata.partials.series.seriesReadOnly')
				</div> 
				<div class="tab-pane fade" id="seo"> 
					@include('titles.titleMenegment.metadata.partials.seo.seoReadOnly')
				</div> 
			</div> 
		</div>						
	</div>
