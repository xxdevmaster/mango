...
<div class="tab-content">
	<div class="tab-pane fade in active" id="filmSubtitles">
		@include('titles.titleManagement.metadata.partials.subtitles.forms.newFilmSubtitleFormReadOnly')
	</div>	
	<div class="tab-pane fade" id="trailerSubtitles">
		@include('titles.titleManagement.metadata.partials.subtitles.forms.newTrailerFormReadOnly')
	</div>
</div>