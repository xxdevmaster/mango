	...
	<div class="col-lg-12"> 
		...
		<div class="tab-content">
			<div class="tab-pane fade in active" id="basic">
				@include('titles.titleManagement.metadata.partials.basic.basic')
			</div>
			<div class="tab-pane fade" id="advanced"> 
				@include('titles.titleManagement.metadata.partials.advanced.advanced')
			</div> 
			<div class="tab-pane fade" id="castAndCrew"> 
				@include('titles.titleManagement.metadata.partials.castAndCrew.castAndCrew')
			</div> 
			<div class="tab-pane fade" id="images"> 
				@include('titles.titleManagement.metadata.partials.images.images')
			</div> 								
			<div class="tab-pane fade" id="subtitles"> 
				@include('titles.titleManagement.metadata.partials.subtitles.subtitles')
			</div> 
			<div class="tab-pane fade" id="ageRates"> 
				@include('titles.titleManagement.metadata.partials.ageRates.ageRates')
			</div> 
			<div class="tab-pane fade" id="series"> 
				@include('titles.titleManagement.metadata.partials.series.series')
			</div> 
			<div class="tab-pane fade" id="seo"> 
				@include('titles.titleManagement.metadata.partials.seo.seo')
			</div> 
		</div> 
	</div>						
</div>
