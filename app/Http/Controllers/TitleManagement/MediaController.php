...
class MediaController extends Controller
{
    ...
    public function mediaShow()
    {
        ...
        return view('titles.titleManagement.media.media', compact('current_menu', 'film', 'allLocales', 'media'));
    }
    ...
    private function drawTemplate($template)
    {
        ...
        switch($template){
            case 'movie' :  $media = [
                            ...
                            return view('titles.titleManagement.media.partials.dubbedVersions.partials.movieAndTrailer', compact('film', 'allLocales', 'filmsMedia'));break;
            case 'trailer' :  $media = [
                                'trailer' => $this->tabDubbedVersions('trailer')
                            ];
	...
	public function filterMediaUploaderUpdateList()
    {
        ...
        return view('titles.titleManagement.media.partials.uploader.partials.mediaUploader', compact('film', 'allLocales', 'media'));
    }
    ...
    public function getUploaderHistory()
    {
        ...
        $html =  view('titles.titleManagement.media.partials.uploader.partials.uploaderHistory', compact('bitjobs'));
        $html = strval($html);
