...
class MetadataController extends Controller
{
	...
	*/
	...
	{	
		...
		return view('titles.titleManagement.metadata.partials.'.$templateName.'.'.$templateName, compact('film', 'allLocales', 'metadata'));
	}
	...
	*/		
	public function getPersonEditForm(Request $request)
	{
		...
		return view('titles.titleManagement.metadata.partials.castAndCrew.forms.editPersonForm', compact('thisPerson', 'LocalePersons', 'allLocales', 'allUniqueLocales'));
	}
